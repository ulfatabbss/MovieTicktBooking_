  ...
  return (
    ...
    style={{backgroundColor:'black',flex:1}}>
      ...
      style={styles.V9}>
        ...
        style={styles.d1}
        resizeMode='contain'
        source={require('../assets/homePageimg/d1.png')}>

        </Image>
        <Image
        style={styles.d1}
        resizeMode='contain'
        source={require('../assets/homePageimg/d2.png')}>

        </Image>
        <Image
        style={styles.d1}
        resizeMode='contain'
        source={require('../assets/homePageimg/d3.png')}>

        </Image>
        <Image
        style={styles.d1}
        resizeMode='contain'
        source={require('../assets/homePageimg/d4.png')}>

        </Image>
        <Image
        style={styles.d1}
        resizeMode='contain'
        source={require('../assets/homePageimg/d5.png')}>

        </Image>

      </View>
      <TouchableOpacity onPress={()=>navigation.navigate('TicketBookingScreen',{data1:Imag})}>
      <View
      style={styles.V3}>
...
const styles = StyleSheet.create({
  ...
  tx4:{
    ...
    color:'white',
    alignSelf:'center',
    fontStyle:'italic',fontWeight:'300',marginTop:15
